      ...
      <div class="w3-half">
        ...
        <!-- <div class="w3-container w3-card w3-amber w3-margin-top w3-margin-bottom w3-mobile">
          ...
          <div class="w3-row w3-margin-left">
            ...
            <div class="w3-rest">
              Sur rendez-vous : du lundi au ve3-amberi</p>
            </div>
          </div> -->
        <div class="w3-container w3-card w3-amber w3-margin-top w3-margin-bottom w3-mobile">
          <h3>Vos avantages</h3>
      ...
      <div class="w3-half">
        ...
        <div class="w3-container w3-mobile w3-margin-top w3-hide-small">
          ...
          <div class="w3-container w3-center w3-section">
            <iframe width="auto" height="250" src="https://www.youtube.com/embed/bLuzokLSneU" title="video1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
          <div class="w3-container w3-center w3-section">
