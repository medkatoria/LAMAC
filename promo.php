...
<body class="w3-light-gray">
  ...
  <div class="w3-content w3-margin-top-large" style="max-width:1200px;">
    ...
    <div class="w3-row-padding">
        <div class="w3-card w3-red w3-padding w3-margin-top w3-hide-small">
            Cette page est optimisée pour la consultation sur téléphone portable. Si vous consultez cette page depuis un ordinateur, merci de vous diriger vers la <a href="/index.php">page d'accueil</a> !
        </div>
      ...
      <div class="w3-container w3-center w3-section">
        <iframe style="max-width:100%" src="https://www.youtube.com/embed/bLuzokLSneU" title="video1" frameborder="0"
          allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
      <div class="w3-container w3-center w3-section">
        <iframe style="max-width:100%" src="https://www.youtube.com/embed/ubXswt2dziw" title="video1" frameborder="0"
          allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
    </div>
